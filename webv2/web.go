...
func getSourceAndTargetProfiles(sessionState *session.SessionState, details migrationDetails) (profiles.SourceProfile, profiles.TargetProfile, utils.IOStreams, string, error) {
	...
	//var dataprocConfig map[string]string
	//dataprocConfig["subnet"] = details.DataprocConfig.Subnetwork
	//dataprocConfig["port"] = details.DataprocConfig.Port
	//dataprocConfig["hostname"] = details.DataprocConfig.Hostname
	//targetProfile.Config = dataprocConfig
	//targetProfile.Config["subnet"] = details.DataprocConfig.Subnetwork
	//targetProfile.Config["port"] = details.DataprocConfig.Port
	//println("*********after prerequisites" + targetProfile.Config["hostname"])
